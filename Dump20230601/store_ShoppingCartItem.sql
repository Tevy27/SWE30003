...
CREATE TABLE `ShoppingCartItem` (
  ...
  KEY `cartId` (`cartId`),
  CONSTRAINT `shoppingcartitem_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `Products` (`productId`),
  CONSTRAINT `shoppingcartitem_ibfk_2` FOREIGN KEY (`cartId`) REFERENCES `ShoppingCart` (`cartId`)
...
INSERT INTO `ShoppingCartItem` VALUES (1,5,1,1),(2,3,2,2);
